...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container.find('.daterangepicker_start_input label').html(fromLabel);
        this.container.find('.daterangepicker_end_input label').html(toLabel);
        if (this.applyClass.length)
            this.container.find('.applyBtn').addClass(this.applyClass);
        if (this.cancelClass.length)
            this.container.find('.cancelBtn').addClass(this.cancelClass);
        this.container.find('.applyBtn').html(applyLabel);
        this.container.find('.cancelBtn').html(cancelLabel);
