    ...
    <div class="padding">
        <div class="card" style="padding: 4px">
            <div class="box-header ">
                <a href="{{route('admin.area.addView')}}">
                    <button class="btn dark pull-left">Add Area</button>
                </a>
            ...
            <div class="container-fluid">
                <form method="get" action="{{route('admin.area.list')}}">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{route('admin.area.list')}}" type="submit" class="btn dark btn-block">Clear</a>
                        </div>
                    </div>
                </form>
                <br>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if(@Auth::user()->permissionsGroup->edit_status)
                                    ...
                                    <a href="{{route('admin.area.updateView',$Banner->id)}}">
    ...
    <script type="text/javascript">
        ...
        function BulkDelete() {
            ...
            if (tempArray.length>0)
            {
                ...
                $.ajax({
                    type:'post',
                    url:'{{route('admin.area.deleteBulk')}}',
