    ...
    <div class="padding">
        <div class="card" style="padding: 4px">
            <div class="box-header ">
                <h3>{{ __('backend.suppliers') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a href="javascript:void">{{ __('backend.suppliers') }}</a>
                </small>
                <br>
                <div>
                    <a  class="btn btn-fw btn-outline-primary marginBottom5"
                        href="{{route("admin.supplier.list")}}">{{ __('backend.all') }} {{ __('backend.suppliers') }}</a>
                    <a  class="btn btn-fw btn-outline-primary marginBottom5"
                       href="{{route("admin.supplier.list")."?status=1"}}">{{ __('backend.active') }} {{ __('backend.suppliers') }}</a>
                    <a class="btn btn-fw btn-outline-primary marginBottom5"
                       href="{{route("admin.supplier.list")."?status=0"}}">{{ __('backend.unactive') }} {{ __('backend.suppliers') }}</a>
                </div>
            </div>
...
{{--                            </th>--}}
                            ...
                            <th class="text-center width50">{{ __('backend.supplierCcde') }}</th>
                            <th class="text-center width50">{{ __('backend.contactName') }}</th>
...
{{--                                </td>--}}
                                ...
                                <td class="text-center">
                                    <label>{{$Banner->supplier_code}}</label>
                                </td>
                                <td class="text-center">
                                    <label>{{$Banner->contact_name}}</label>
                                </td>
                                <td class="text-center">
                                            ...
                                            <div class="modal-body text-center p-lg">
                                                <div class="container-fluid">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input name="type" value="{{$Banner->type}}" required class="form-control"><br>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input name="supplier_code" value="{{$Banner->supplier_code}}" required class="form-control"><br>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input name="contact_name" value="{{$Banner->contact_name}}" required class="form-control"><br>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input name="email" value="{{$Banner->email}}" required class="form-control"><br>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input name="phone" value="{{$Banner->phone}}" required class="form-control"><br>
                                                        </div>
                                                    </div>
...
{{--                </footer>--}}
    ...
    <div id="m-add-supplier" class="modal fade" data-backdrop="true">
        <div class="modal-dialog" id="animate">
                    ...
                    <div class="modal-body text-center p-lg">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input name="type" required class="form-control"><br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <input name="supplier_code" required class="form-control"><br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <input name="contact_name" required class="form-control"><br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <input name="email" required class="form-control"><br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <input name="phone" required class="form-control"><br>
                                </div>
                            </div>
