...
@section('content')
        ...
        <div class="padding">
            ...
            <div class="card ">
                ...
                <form method="post" id="AddTag" action="{{route('admin.tag.create')}}" enctype="multipart/form-data">
                    @csrf
