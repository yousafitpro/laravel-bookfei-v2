    ...
    <div class="padding">
        <div class="card" style="padding: 4px">
            <div class="box-header ">
                <a href="{{route('admin.tag.addView')}}">
                    <button class="btn dark pull-left">Add Tag</button>
                </a>
            ...
            <div class="container-fluid">
                <form method="get" action="{{route('admin.tag.list')}}">
                    <div class="row">
                        <div class="col-md-3">
                            <input name="searchWord" placeholder="tag Name" class="form-control" value="{{session('searchWord','')}}">
                        </div>
                        ...
                        <div class="col-md-2">
                            <a href="{{route('admin.tag.clear')}}" class="btn dark btn-block">Clear</a>
                        </div>
                    </div>
                </form>
                <br>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if(@Auth::user()->permissionsGroup->edit_status)
                                    ...
                                    <a href="{{route('admin.tag.updateView',$Banner->id)}}">
                            ...
                            <div class="modal-dialog" id="animate">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ route("admin.tag.delete",["id"=>$Banner->id]) }}"
    ...
    <script type="text/javascript">
        ...
        function BulkDelete() {
            ...
            if (tempArray.length>0)
            {
                ...
                $.ajax({
                    type:'post',
                    url:'{{route('admin.tag.deleteBulk')}}',
