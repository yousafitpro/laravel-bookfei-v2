    ...
    <div class="padding">
        <div class="card" style="padding: 4px">
            <div class="box-header ">
                <h3>{{ __('backend.airports') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a href="javascript:void">{{ __('backend.airports') }}</a>
                </small>
                <br>
                <div>
                    <a  class="btn btn-fw btn-outline-primary marginBottom5"
                        href="{{route("admin.airport.list")}}">{{ __('backend.all') }} {{ __('backend.airports') }}</a>
                    <a  class="btn btn-fw btn-outline-primary marginBottom5"
                       href="{{route("admin.airport.list")."?status=1"}}">{{ __('backend.active') }} {{ __('backend.airports') }}</a>
                    <a class="btn btn-fw btn-outline-primary marginBottom5"
                       href="{{route("admin.airport.list")."?status=0"}}">{{ __('backend.unactive') }} {{ __('backend.airports') }}</a>
                </div>
            </div>
...
{{--                            </th>--}}
                            ...
                            <th class="text-center width50">{{ __('backend.lataCode') }}</th>
                                ...
                                <div class="modal-dialog" id="animate">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route("admin.airport.delete",["id"=>$Banner->id]) }}"
...
{{--                </footer>--}}
    ...
    <div id="m-add-airport" class="modal fade" data-backdrop="true">
        <div class="modal-dialog" id="animate">
