    ...
    <div class="padding">
        <div class="card" style="padding: 4px">
            <div class="box-header ">
                <h3>{{ __('backend.airlines') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
                    <a href="javascript:void">{{ __('backend.airlines') }}</a>
                </small>
                <br>
                <div>
                    <a  class="btn btn-fw btn-outline-primary marginBottom5"
                        href="{{route("admin.airline.list")}}">{{ __('backend.all') }} {{ __('backend.airlines') }}</a>
                    <a  class="btn btn-fw btn-outline-primary marginBottom5"
                       href="{{route("admin.airline.list")."?status=1"}}">{{ __('backend.active') }} {{ __('backend.airlines') }}</a>
                    <a class="btn btn-fw btn-outline-primary marginBottom5"
                       href="{{route("admin.airline.list")."?status=0"}}">{{ __('backend.unactive') }} {{ __('backend.airlines') }}</a>
                </div>
            </div>
...
{{--                </footer>--}}
    ...
    <div id="m-add-airline" class="modal fade" data-backdrop="true">
        <div class="modal-dialog" id="animate">
