    ...
    <div class="padding">
        <div class="card" style="padding: 4px">
            <div class="box-header ">
                <a href="{{route('admin.city.addView')}}">
                    <button class="btn dark pull-left">Add New City</button>
                </a>
            ...
            <div class="container-fluid">
                <form method="get" action="{{route('admin.city.list')}}">
                    <div class="row">
                        <div class="col-md-2">
                            <input name="searchWord" placeholder="city Name" class="form-control" value="{{session('searchWord','')}}">
                        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if(@Auth::user()->permissionsGroup->edit_status)
                                    ...
                                    <a href="{{route('admin.city.updateView',$Banner->id)}}">
    ...
    <script type="text/javascript">
        ...
        function BulkDelete() {
            ...
            if (tempArray.length>0)
            {
                ...
                $.ajax({
                    type:'post',
                    url:'{{route('admin.city.deleteBulk')}}',
