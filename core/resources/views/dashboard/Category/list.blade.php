    ...
    <div class="padding">
        <div class="card" style="padding: 4px">
            <div class="box-header ">
                <a href="{{route('admin.category.addView')}}">
                    <button class="btn dark pull-left">Add New Category</button>
                </a>
            ...
            <div class="container-fluid">
                <form method="get" action="{{route('admin.category.list')}}">
                    <div class="row">
                        <div class="col-md-2">
                            <input name="searchWord" placeholder="Category Name" class="form-control" value="{{session('searchWord','')}}">
                        </div>
                            ...
                            <div class="modal-dialog" id="animate">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ route("admin.category.delete",["id"=>$Banner->id]) }}"
    ...
    <script type="text/javascript">
        ...
        function BulkDelete() {
            ...
            if (tempArray.length>0)
            {
                ...
                $.ajax({
                    type:'post',
                    url:'{{route('admin.category.deleteBulk')}}',
