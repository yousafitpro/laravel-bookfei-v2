    ...
    <div class="padding">
        <div class="card" style="padding: 4px">
            <div class="box-header ">
                <a href="{{route('admin.destination.addView')}}">
                    <button class="btn dark pull-left">Add New Destination</button>
                </a>
            ...
            <div class="container-fluid">
                <form method="get" action="{{route('admin.destination.list')}}">
                    <div class="row">
                        <div class="col-md-2">
                            <input name="searchWord" placeholder="destination Name" class="form-control" value="{{session('searchWord','')}}">
                        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if(@Auth::user()->permissionsGroup->edit_status)
                                    ...
                                    <a href="{{route('admin.destination.updateView',$Banner->id)}}">
                            ...
                            <div class="modal-dialog" id="animate">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ route("admin.destination.delete",["id"=>$Banner->id]) }}"
    ...
    <script type="text/javascript">
        ...
        function BulkDelete() {
            ...
            if (tempArray.length>0)
            {
                ...
                $.ajax({
                    type:'post',
                    url:'{{route('admin.destination.deleteBulk')}}',
