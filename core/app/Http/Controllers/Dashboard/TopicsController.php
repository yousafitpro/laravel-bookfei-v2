        ...
        if ($totalFiltered > 0) {
            ...
            foreach ($Topics as $Topic) {
                ...
                $edit_btn .= "<a class=\"btn btn-sm info\"
                                           href=\"" . ((@$Topic->webmasterSection->type == 4 || @$Topic->webmasterSection->type == 6) ? route("topicView", ["webmasterId" => @$Topic->webmasterSection->id, "id" => $Topic->id]) : Helper::topicURL($Topic->id)) . "\"  data-toggle=\"tooltip\" data-original-title=\" " . __('backend.viewDetails') . "\"" . ((@$Topic->webmasterSection->type == 4 || @$Topic->webmasterSection->type == 6) ? "" : "target='_blank'") . ">
